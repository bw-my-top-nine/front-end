...
const CreateCategory = props => {
	...
	const submitForm = (e) => {
		e.preventDefault();
		if (props.edit && props.edit.id) { /*! PROPS.EDIT.ID IS UNDEFINED AND THIS DOES NOT WORK YET UNTIL ZACH MAKES ID AVAILABLE FROM BACKEND SOMEHOW */
			axios.put(`https://top-nine.herokuapp.com/api/categories/${props.edit.id}`, cat)
			.then(resp => {
			...
			axios.post(`https://top-nine.herokuapp.com/api/categories/${props.userId}/categories`, cat)
			.then(resp => {
				console.log('this is in CatForm', resp);
				setCat({
					name: "",
